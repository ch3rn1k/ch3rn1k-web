...
const Portfolio = ({ l10n }) => {
  const discordBotsData = useRef([
    {
      ...
      description:
        l10n.key === "ru"
          ? "Бот с оповещениями о новых ЖБ"
          : "Bot with notifications about new warns from forum",
      status: "on",
    },
    {
      title: "Armavir Bot",
      description:
        l10n.key === "ru"
          ? "Ботярикс с кучей функционала"
          : "Bot with a lot of functions",
      status: "private",
    },
    {
      ...
      description:
        l10n.key === "ru"
          ? "Музыкальный бот с фичами рэйпа"
          : "Music bot with rape features",
      status: "off",
    },
    {
      ...
      description:
        l10n.key === "ru"
          ? "Бот который создает приватные комнаты"
          : "Bot that creates private rooms",
      status: "off",
    },
    {
      ...
      description:
        l10n.key === "ru"
          ? "Работяга который прикалывается"
          : "The hard worker who makes fun",
      status: "off",
    },
    {
      ...
      description:
        l10n.key === "ru"
          ? "Пишет самые тупые шутки"
          : "Writes the dumbest jokes in the world",
      status: "off",
    },
    {
      ...
      description:
        l10n.key === "ru"
          ? "Счетчик онлайна для RUST проектов"
          : "Online counter for RUST projects",
      status: "off",
    },
    {
      ...
      description:
        l10n.key === "ru"
          ? "Предводитель и контролер семьи в CRMP"
          : "Family leader and controller in CRMP",
      status: "off",
    },
  ]).current;
    ...
    },
    {
      ...
      title:
        l10n.key === "ru"
          ...
          : "Shitty the wheel of fortune",
      description:
        l10n.key === "ru"
          ? "Колесо фортуны при донатиках"
          : "Wheel of Fortune on donuts",
    },
    {
      title: "Majestic Web Scrapper",
      description:
        l10n.key === "ru"
          ? "Паук который вечно парсит темы на форуме"
          : "A crawler that always parses forum threads",
    },
  ]).current;
  const telegramData = useRef([
    ...
    },
    {
      ...
      description:
        l10n.key === "ru"
          ? "Парсер постов для отправки в DS"
          : "Posts parser to send them next to Discord",
      status: "private",
    },
    {
      title: "Giveway Bot",
  ...
  const desktopData = useRef([
    {
      ...
      description:
        l10n.key === "ru"
          ? "Лучший биндер для гташки 5"
          : "Best binder for GTA5",
    },
  ]).current;
    ...
    <section id="portfolio">
      ...
      <div className="my-contacts">
        ...
        <div className="my-contacts--links">
          <a href="https://vk.com/ch3rn1k" target="_blank">
            VK
          </a>
          <a href="https://t.me/ch3rn1k" target="_blank">
            TELEGRAM
          </a>
          <a href="https://steamcommunity.com/id/ch3rn1k" target="_blank">
            STEAM
          </a>
        </div>
      </div>
